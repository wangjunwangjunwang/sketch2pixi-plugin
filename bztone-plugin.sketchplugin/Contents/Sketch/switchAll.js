...
var util = __webpack_require__(/*! ./util */ "./src/util.js"); // const { toArray } = require('util')
...
/* harmony default export */ __webpack_exports__["default"] = (function (content) {
  ...
  pages.forEach(function (page) {
    ...
    artboards.forEach(function (artboard) {
      allArtboards.push(artboard); // console.log('artboardID : ' + artboard.objectID())
  ...
  pages.forEach(function (page, index) {
    ...
    var pixiFile = getScriptFolder(globalContent) + '/pixi.json';
    ...
    if (name == 'BG') {
      ...
      if (layer.flow() && layer.flow().destinationArtboardID()) {
        if (type === MSHotspotLayer) {
          ...
          var targetId = layer.flow().destinationArtboardID(); // console.log('targetId : ' + targetId)

          var artboardLayer = getArtboard(targetId); // console.log('artboardLayer')
...
function getArtboard(targetId) {
  ...
  for (var i = 0; i < allArtboards.length; i++) {
    var artboard = allArtboards[i]; // console.log('artboard : ' + artboard.objectID())
